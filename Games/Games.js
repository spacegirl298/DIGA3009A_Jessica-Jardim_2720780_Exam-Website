// Safe Dollar Studios games data with actual Itch.io slugs
const safeDollarGames = [
  {
    slug: "lab-rumble",
    title: "Lab Rumble",
    description: "A fast-paced 2D projectile brawler where two scientists fight for the last escape ship off a dying Earth. Pick up items around the lab, hurl them at your opponent, and survive the chaos to win.",
    fallbackImage: "./Images/Lab_Rumble_Cover.png",
  },
  {
    slug: "fire-keeper-prototype",
    title: "Fire Keeper",
    description: "A medieval adventure game where you explore a dark cave with a fading flame. Light campfires, solve puzzles, avoid ghosts, and uncover the world's hidden paths as you fight to keep hope alive.",
    fallbackImage: "./Images/Fire_Keeper_Cover.png",
  },
  {
    slug: "arcadia",
    title: "Arcadia",
    description: "A fast-paced 2D arcade-style, time-based coin collector game. Master tight controls, dodge obstacles, and grab as many coins as possible to achieve the highest score.",
    fallbackImage: "./Images/Arcadia_Cover.png",
  },
  {
    slug: "cozycorners",
    title: "CozyCorners",
    description: "An isometric cleaning and decorating game where you turn messy homes into warm, personalized spaces through satisfying cleanup and creative design.",
    fallbackImage: "./Images/CozyCorners_Cover.png",
  },
  {
    slug: "desert-skies",
    title: "Desert Skies",
    description: "A side-scrolling shoot 'em up where a rebel crew battles powerful corporations. Dodge attacks, defeat enemy waves, and unleash devastating ultimates in a fast-paced, retro-inspired adventure.",
    fallbackImage: "./Images/Desert_Skies_Cover.png",
  },
  {
    slug: "escape-room",
    title: "Escape Room",
    description: "A puzzle game where you solve challenges, crack codes, and find keys to escape before time runs out.",
    fallbackImage: "./Images/Escape_Room_Cover.png",
  },
  {
    slug: "mage-brothers",
    title: "Mage Brothers",
    description: "A 2-player wizard shooter where you cast chaotic spells with surprising side effects. Battle your rival and be the first to 5 kills to claim victory!",
    fallbackImage: "./Images/Mage_Brothers_Cover.png",
  },
  {
    slug: "rogue-slasher",
    title: "Rogue Slasher",
    description: "A 3rd-person shooter where you survive waves of enemies, collect rare drops, and craft powerful gear—while the enemies grow stronger with every wave.",
    fallbackImage: "./Images/Rogue_Slasher_Cover.png",
  },
  {
    slug: "sky-isles",
    title: "Sky Isles",
    description: "A 3D platformer where you collect gems and coins, solve light puzzles, and explore levels while unlocking fun items along the way.",
    fallbackImage: "./Images/Sky_Isles_Cover.png",
  },
  {
    slug: "space-base",
    title: "Space Base",
    description: "An action tower-defense prototype where you defend your central tower from waves of enemies, earn money, and build turrets to survive as long as possible.",
    fallbackImage: "./Images/Space_Base_Cover.png",
  },
  {
    slug: "the-running-man",
    title: "The Running Man",
    description: "An endless runner where you dodge obstacles, run on walls, and test your reflexes as the speed keeps increasing.",
    fallbackImage: "./Images/The_Running_Man_Cover.png",
  },
  {
    slug: "three-man-team",
    title: "Three Man Team",
    description: "A puzzle platformer where you control three characters with unique abilities—speed, strength, and teleportation—to reach the end of each level.",
...
function createFallbackGameData(game) {
  const prices = [9.99, 12.99, 14.99, 11.99, 16.99, 13.99, 10.99, 15.99, 8.99, 17.99, 7.99, 18.99];
  const randomPrice = prices[Math.floor(Math.random() * prices.length)];
  
  return {
    ...game,
    price: randomPrice,
    published_at: new Date(2023, Math.floor(Math.random() * 12), 1).toISOString(),
...
function loadDemoData() {
  ...
  setTimeout(() => {
    allGames = safeDollarGames.map((game, index) => createFallbackGameData(game));
    displayGames(allGames);
